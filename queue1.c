...
/*in the terminal a part of the output may be cut off(as the output for 100 initial jobs is large).Then please go to the edit menu in the termianl and under preferences, 
 click on the scrolling tab and increase the number of lines*/
...
void createqueue()
{
	...
	int i;
	srand(time(0));
	for(i=0;i<100;i++)//Creating 100 jobs
	{
		int tim;
